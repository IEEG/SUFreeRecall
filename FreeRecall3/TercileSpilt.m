...
allexF = cellfun(@(m,md,bn) mean(sum(m(strcmp({xllog(ismember({xllog.batchname},bn)&([xllog.class]>0)).catsel},'Face')))<= ...
    sum(md(:,strcmp({xllog(ismember({xllog.batchname},bn)&([xllog.class]>0)).catsel},'Face')),2)), match,matchDist,{batches(1) batches(2:3) batches(4) batches(5)});
...
% Face units
fexF = cellfun(@(m,md,bn) mean(sum(m(strcmp({xllog(ismember({xllog.batchname},bn)&([xllog.class]>0)).catsel},'Face')))<=...
    sum(md(:,strcmp({xllog(ismember({xllog.batchname},bn)&([xllog.class]>0)).catsel},'Face')),2)), matchF,matchDistF,...
    {batches(1) batches(2:3) batches(4) batches(5)});
